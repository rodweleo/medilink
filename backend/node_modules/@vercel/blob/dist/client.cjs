...
var _chunkG7KJHPQNcjs = require('./chunk-G7KJHPQN.cjs');
...
function createPutExtraChecks(methodName) {
  return function extraChecks(options) {
    if (typeof window === "undefined") {
      throw new (0, _chunkG7KJHPQNcjs.BlobError)(
        `${methodName} must be called from a client environment`
      );
    }
    if (!options.token.startsWith("vercel_blob_client_")) {
      throw new (0, _chunkG7KJHPQNcjs.BlobError)(`${methodName} must be called with a client token`);
    }
    if (
...
var put = _chunkG7KJHPQNcjs.createPutMethod.call(void 0, {
  allowedOptions: ["contentType"],
  extraChecks: createPutExtraChecks("client/`put`")
});
var createMultipartUpload = _chunkG7KJHPQNcjs.createCreateMultipartUploadMethod.call(void 0, {
  allowedOptions: ["contentType"],
  extraChecks: createPutExtraChecks("client/`createMultipartUpload`")
});
var createMultipartUploader = _chunkG7KJHPQNcjs.createCreateMultipartUploaderMethod.call(void 0, 
  {
    allowedOptions: ["contentType"],
    extraChecks: createPutExtraChecks("client/`createMultipartUpload`")
  }
);
var uploadPart = _chunkG7KJHPQNcjs.createUploadPartMethod.call(void 0, {
  allowedOptions: ["contentType"],
  extraChecks: createPutExtraChecks("client/`multipartUpload`")
});
var completeMultipartUpload = _chunkG7KJHPQNcjs.createCompleteMultipartUploadMethod.call(void 0, 
  {
    allowedOptions: ["contentType"],
    extraChecks: createPutExtraChecks("client/`completeMultipartUpload`")
  }
);
var upload = _chunkG7KJHPQNcjs.createPutMethod.call(void 0, {
  allowedOptions: ["contentType"],
  extraChecks(options) {
    if (typeof window === "undefined") {
      throw new (0, _chunkG7KJHPQNcjs.BlobError)(
...
async function handleUpload({
  ...
  var _a, _b, _c, _d;
  const resolvedToken = _chunkG7KJHPQNcjs.getTokenFromOptionsOrEnv.call(void 0, { token });
  ...
  switch (type) {
    ...
    case "blob.upload-completed": {
      ...
      if (!signature) {
        throw new (0, _chunkG7KJHPQNcjs.BlobError)("Missing callback signature");
      }
      ...
      if (!isVerified) {
        throw new (0, _chunkG7KJHPQNcjs.BlobError)("Invalid callback signature");
      }
      await onUploadCompleted(body.payload);
      return { type, response: "ok" };
    }
    default:
      throw new (0, _chunkG7KJHPQNcjs.BlobError)("Invalid event type");
  }
}
async function retrieveClientToken(options) {
  ...
  if (!res.ok) {
    throw new (0, _chunkG7KJHPQNcjs.BlobError)("Failed to  retrieve the client token");
  }
  try {
...
async function generateClientTokenFromReadWriteToken({
  ...
  const readWriteToken = _chunkG7KJHPQNcjs.getTokenFromOptionsOrEnv.call(void 0, { token });
  ...
  if (!securedKey) {
    throw new (0, _chunkG7KJHPQNcjs.BlobError)("Unable to sign client token");
  }
